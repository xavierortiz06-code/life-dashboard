  ...
  return (
    <div style={{ position: 'relative', width: SIZE, height: SIZE }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 30, fontWeight: 800, fontFamily: 'var(--mono)', lineHeight: 1, letterSpacing: '-0.03em', color }}>
          {done}
        </div>
...
function GoLink({ to, children }) {
  return (
    <Link to={to} style={{
      ...
      letterSpacing: '.04em', opacity: 0.75,
